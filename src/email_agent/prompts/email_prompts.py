    ...
    return [
        {
            ...
            "content": (
                ...
                "Examples:\n"
                "- 'Interview calendar hold for Monday' -> meeting, score around 70, needs_action=true\n"
                "- 'Your free trial ends tomorrow' -> finance, score around 80, needs_action=true\n"
                "- 'Not urgent, but please send the latest draft by Friday' -> urgent, score around 85, needs_action=true\n"
                "- 'When you get a chance, can you send the photo?' -> info, score around 35, needs_action=false\n"
                "- 'Important: your premium discount ends today' -> low_priority, score around 10, needs_action=false"
            ),
        },
        {
            "role": "user",
